...
//connection mongobd with the code present in mongobd database
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@yoga.ifk1yha.mongodb.net/?retryWrites=true&w=majority&appName=yoga`;
...
app.get('/', (req, res) => {
  res.send('Yoga master is running')
});
...
//final sCJLFH1nXo0oBth7
//mongodb+srv://hemaheggade:<password>@yoga-master.qpstmi7.mongodb.net/?retryWrites=true&w=majority&appName=yoga-master
